            ...
            <div className="bg-[#111827]/60 border border-white/10 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden group/card">
              ...
              <div className="mb-10 relative">
                ...
                <p className="text-white/40 text-sm font-medium mt-2">
                  Sign in to manage your bookings and clients.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative">
                <AnimatePresence mode="wait">
                  {savedProfile ? (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-sky-400 uppercase tracking-widest font-black">
                            Remembered Account
                          </p>
                        </div>
                      </div>
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                    >
                      <label className="text-[11px] font-black text-white/30 uppercase tracking-[0.2em] ml-2">
                        Email Address
                      </label>
                ...
                <div className="flex items-center gap-3 px-2">
                  ...
                  >
                    <div
                      className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all duration-300 ${rememberMe ? "bg-sky-500 border-sky-500 shadow-lg shadow-sky-500/30" : "border-white/10 group-hover:border-white/30"}`}
                    >
                      {rememberMe && (
              ...
              <div className="mt-10 pt-6 border-t border-white/5">
                <Link
                  to="/signup"
                  className="block text-center text-sm font-black text-white/40 hover:text-sky-400 transition-colors uppercase tracking-widest"
                >
